...
$(document).ready(function () {
    ...
    if (response != null && response !== "") {
        ...
        cbestado.value = "("+response.pessoa.endereco.cidade.estado.id+") "+response.pessoa.endereco.cidade.estado.nome;
        txidestado.value = response.pessoa.endereco.cidade.estado.id;
        cbcidade.value = "("+response.pessoa.endereco.cidade.id+") "+response.pessoa.endereco.cidade.nome;
        txidcidade.value = response.pessoa.endereco.cidade.id;
