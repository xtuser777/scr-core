    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                ...
                routes.MapRoute(name: "tipocamonhao", template: "/gerenciar/tipocaminhao/index", defaults: new { controller = "TipoCaminhao", action = "Index" });
                routes.MapRoute(name: "tipocamonhao_novo", template: "/gerenciar/tipocaminhao/novo", defaults: new { controller = "TipoCaminhao", action = "Novo" });
                routes.MapRoute(name: "tipocamonhao_detalhes", template: "/gerenciar/tipocaminhao/detalhes", defaults: new { controller = "TipoCaminhao", action = "Detalhes" });
